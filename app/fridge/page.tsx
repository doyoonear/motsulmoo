      ...
      <main className={styles.main}>
        <div className={styles.header}>
          ...
          <button
            ...
            onClick={() => router.push('/fridge/gallery')}
            title="구매 내역 업로드"
          >
        ...
        <h3 className={styles.subtitle}>냉장고 재료 추가하기</h3>
        <div className={styles.addButtonGroup}>
          <button className={styles.addButtonHalf} onClick={() => setShowAddModal(true)}>
            ...
            <span className={styles.buttonText}>직접 추가하기</span>
          </button>
          <button className={styles.addButtonHalf} onClick={() => setShowImageUpload(true)}>
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" className={styles.buttonIcon}>
            ...
            <span className={styles.buttonText}>구매내역으로 추가하기</span>
          </button>
        </div>
